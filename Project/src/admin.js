document.querySelector("#add_button").addEventListener("click", checkInput);
...
function addProduct(){
	...
	localStorage.setItem('data', nameProduct);
}
...
function removeProduct() {
	...
	localStorage.deleteItem('data', nameProduct);
}
...
function total(){
	...
	totalDisplay.innerHTML = total + " dollars";
}
